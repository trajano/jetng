...
public class EmitModel {
    ...
    public void setArgumentConstructorParameterType(
            final String argumentConstructorParameterType) {
    ...
    public void setSupportedAnnotationTypes(
            final String[] supportedAnnotationTypes) {
